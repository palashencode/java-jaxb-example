 ...
 * generated in the com.java.app.domain package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddOrder_QNAME = new QName("http://www.example.com/java-jaxb", "addOrder");
    private final static QName _AddOrderResponse_QNAME = new QName("http://www.example.com/java-jaxb", "addOrderResponse");
    private final static QName _DeleteOrder_QNAME = new QName("http://www.example.com/java-jaxb", "deleteOrder");
    private final static QName _DeleteOrderResponse_QNAME = new QName("http://www.example.com/java-jaxb", "deleteOrderResponse");
    private final static QName _GetOrder_QNAME = new QName("http://www.example.com/java-jaxb", "getOrder");
    private final static QName _GetOrderResponse_QNAME = new QName("http://www.example.com/java-jaxb", "getOrderResponse");
    private final static QName _GetOrders_QNAME = new QName("http://www.example.com/java-jaxb", "getOrders");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://www.example.com/java-jaxb", "getOrdersResponse");
    private final static QName _PurchaseOrder_QNAME = new QName("http://www.example.com/java-jaxb", "purchaseOrder");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.java.app.domain
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://www.example.com/java-jaxb", name = "addOrder")
     ...
     */
    @XmlElementDecl(namespace = "http://www.example.com/java-jaxb", name = "addOrderResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://www.example.com/java-jaxb", name = "deleteOrder")
     ...
     */
    @XmlElementDecl(namespace = "http://www.example.com/java-jaxb", name = "deleteOrderResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://www.example.com/java-jaxb", name = "getOrder")
     ...
     */
    @XmlElementDecl(namespace = "http://www.example.com/java-jaxb", name = "getOrderResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://www.example.com/java-jaxb", name = "getOrders")
     ...
     */
    @XmlElementDecl(namespace = "http://www.example.com/java-jaxb", name = "getOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://www.example.com/java-jaxb", name = "purchaseOrder")
