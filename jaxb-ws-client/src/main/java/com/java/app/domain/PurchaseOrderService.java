 ...
 * 
 */
@WebServiceClient(name = "PurchaseOrderService", targetNamespace = "http://www.example.com/java-jaxb", wsdlLocation = "http://localhost:8080/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PURCHASEORDERSERVICE_QNAME = new QName("http://www.example.com/java-jaxb", "PurchaseOrderService");
    ...
    public PurchaseOrders getPurchaseOrderPort() {
        return super.getPort(new QName("http://www.example.com/java-jaxb", "PurchaseOrderPort"), PurchaseOrders.class);
    }
    ...
    public PurchaseOrders getPurchaseOrderPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.com/java-jaxb", "PurchaseOrderPort"), PurchaseOrders.class, features);
    }
